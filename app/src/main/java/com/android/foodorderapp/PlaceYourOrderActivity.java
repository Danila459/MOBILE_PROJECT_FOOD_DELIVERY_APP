...
public class PlaceYourOrderActivity extends AppCompatActivity {
    ...
    private void calculateTotalAmount(RestaurantModel restaurantModel) {
        ...
        tvSubtotalAmount.setText(String.format("%.2f", subTotalAmount) + " руб");
        if(isDeliveryOn) {
            tvDeliveryChargeAmount.setText(String.format("%.2f", restaurantModel.getDelivery_charge()) + " руб");
            subTotalAmount += restaurantModel.getDelivery_charge();
        }
        tvTotalAmount.setText(String.format("%.2f", subTotalAmount) + " руб");
    }
